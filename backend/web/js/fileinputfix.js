...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _listen: function () {
            ...
            if($(".kv-preview-thumb .file-preview-initial").hasClass("file-preview-success")==false) {
                self.getFrames('.file-preview-initial').addClass("file-preview-success file-preview-custom");
                self.getFrames('.file-preview-initial').removeClass("file-preview-initial");
            ...
            self._getThumbs($h.FRAMES + '.file-preview-success').each(function () {
                ...
                self._handler($remove, 'click', function () {
                    ...
                    $thumb.fadeOut('slow', function () {
                        ...
                        if($thumb.hasClass("file-preview-custom")) {
                            self._listen();
                            self.clear();
                        }
                        $thumb.remove();
