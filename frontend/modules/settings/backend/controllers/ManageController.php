...
use frontend\modules\settings\common\models\SettingsSearch;
...
/**
 * ManageController implements the CRUD actions for Settings model.
 */
class ManageController extends DefaultBackendController
{
